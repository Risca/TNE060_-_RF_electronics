...
The microstrip that was analysed was defined in problem 2.13 in [1] as
...
\end{table}
Negative signs for $\Gamma_0$ values in Table \ref{table: RC and SWR} represents a 180 $^\circ$ phase shift for the reflected wave compared to the incident.
\end{document}
